 ...
 *
 * Plugin bundles are built with `external: ["@abacus-lab/plugin-sdk/ui", "react", "react-dom"]`,
 ...
 * - `import { ... } from "@abacus-lab/plugin-sdk/ui";`
 *
...
function rewriteBareSpecifiers(source: string): string {
  ...
  const rewrites: Record<string, string> = {
    '"@abacus-lab/plugin-sdk/ui"': `"${getShimBlobUrl("sdk-ui")}"`,
    "'@abacus-lab/plugin-sdk/ui'": `'${getShimBlobUrl("sdk-ui")}'`,
    '"@abacus-lab/plugin-sdk/ui/hooks"': `"${getShimBlobUrl("sdk-ui")}"`,
    "'@abacus-lab/plugin-sdk/ui/hooks'": `'${getShimBlobUrl("sdk-ui")}'`,
 ...
 * of `@abacus-lab/plugin-sdk/ui`, `react`, and `react-dom` resolve to the
