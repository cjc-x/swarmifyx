...
import { createDb, instanceUserRoles, invites } from "@papertape/db";
...
export async function bootstrapCeoInvite(opts: {
  ...
  try {
    ...
    p.log.info("If using embedded-postgres, start the Papertape server and run this command again.");
  } finally {
