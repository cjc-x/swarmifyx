...
base_cwd="${PAPERTAPE_WORKSPACE_BASE_CWD:?PAPERTAPE_WORKSPACE_BASE_CWD is required}"
worktree_cwd="${PAPERTAPE_WORKSPACE_CWD:?PAPERTAPE_WORKSPACE_CWD is required}"
