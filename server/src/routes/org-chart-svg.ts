/**
 * Server-side SVG renderer for Abacus org charts.
...
// Abacus logo: scaled icon (~16px) + wordmark (13px), vertically centered
const ABACUS_LOGO_SVG = `<g>
  ...
  <text x="22" y="11.5" font-family="system-ui, -apple-system, sans-serif" font-size="13" font-weight="600" fill="currentColor">Abacus</text>
</g>`;
