...
import type { ToolRunContext, ToolResult, ExecuteToolParams } from "@papertape/plugin-sdk";
...
export interface PluginToolRegistry {
   ...
   */
  registerPlugin(pluginId: string, manifest: PapertapePluginManifestV1, pluginDbId?: string): void;
