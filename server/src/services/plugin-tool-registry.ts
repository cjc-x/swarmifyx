...
import type { ToolRunContext, ToolResult, ExecuteToolParams } from "@swarmifyx/plugin-sdk";
...
export interface PluginToolRegistry {
   ...
   */
  registerPlugin(pluginId: string, manifest: SwarmifyxPluginManifestV1, pluginDbId?: string): void;
