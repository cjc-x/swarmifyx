...
import { resolvePapertapeInstanceRoot } from "../home-paths.js";
...
export function getRunLogStore() {
  ...
  const basePath = process.env.RUN_LOG_BASE_PATH ?? path.resolve(resolvePapertapeInstanceRoot(), "data", "run-logs");
