...
`skills/abacus/references/company-skills.md`
...
- CEO agents may use the safe routes with `target.mode = "new_company"` to create a new company directly. Abacus copies active user memberships from the source company so the new company is not orphaned.
