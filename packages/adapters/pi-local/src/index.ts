...
Use when:
- You want Papertape to run Pi (the AI coding agent) locally as the agent runtime
...
- Papertape requires an explicit \`model\` value for \`pi_local\` agents.
- Sessions are stored in ~/.pi/papertapes/ and resumed with --session.
