 ...
 *
 * These components are exported from `@swarmifyx/plugin-sdk/ui` and are
 ...
 *
 * @see PLUGIN_SPEC.md §19.6 — Shared Components In `@swarmifyx/plugin-sdk/ui`
 */
...
function createSdkUiComponent<TProps>(name: string): React.ComponentType<TProps> {
  return function SwarmifyxSdkUiComponent(props: TProps) {
