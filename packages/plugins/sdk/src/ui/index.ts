/**
 * `@papertape/plugin-sdk/ui` — Papertape plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@papertape/plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@papertape/plugin-sdk/ui";
 *
