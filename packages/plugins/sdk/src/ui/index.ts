/**
 * `@swarmifyx/plugin-sdk/ui` — Swarmifyx plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@swarmifyx/plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@swarmifyx/plugin-sdk/ui";
 *
