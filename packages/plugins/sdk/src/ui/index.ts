/**
 * `@abacus-lab/plugin-sdk/ui` — Abacus plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@abacus-lab/plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@abacus-lab/plugin-sdk/ui";
 *
