...
function requireCapability(manifest: SwarmifyxPluginManifestV1, allowed: Set<PluginCapability>, capability: PluginCapability) {
 ...
 * can validate plugin behavior without spinning up the Swarmifyx server runtime.
 */
