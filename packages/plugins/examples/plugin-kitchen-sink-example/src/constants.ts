import type { PluginLauncherRegistration } from "@swarmifyx/plugin-sdk";

export const PLUGIN_ID = "swarmifyx-kitchen-sink-example";
...
export const DEFAULT_CONFIG = {
  ...
  workspaceScratchFile: ".swarmifyx-kitchen-sink-demo.txt",
} as const;
