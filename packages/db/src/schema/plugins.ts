...
import type { PluginCategory, PluginStatus, SwarmifyxPluginManifestV1 } from "@swarmifyx/shared";
...
export const plugins = pgTable(
  "plugins",
  {
    ...
    manifestJson: jsonb("manifest_json").$type<SwarmifyxPluginManifestV1>().notNull(),
