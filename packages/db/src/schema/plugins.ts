...
import type { PluginCategory, PluginStatus, PapertapePluginManifestV1 } from "@papertape/shared";
...
export const plugins = pgTable(
  "plugins",
  {
    ...
    manifestJson: jsonb("manifest_json").$type<PapertapePluginManifestV1>().notNull(),
